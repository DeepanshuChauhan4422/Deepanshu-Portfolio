...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-6(wowfmvv%c6qjdbkxuuq8y55(ry5lw%1@)10#5h4fskd(^+-q')
...
# Use PostgreSQL on Render if DATABASE_URL is defined
